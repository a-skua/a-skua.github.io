...
> #38248 defined a new compiler directive, go:wasmimport, for interfacing with
> host defined functions. This allowed calling from Go code into host functions,
> but it’s still not possible to call from the WebAssembly (Wasm) host into Go
> code.
